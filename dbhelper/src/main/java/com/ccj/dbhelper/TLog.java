...
public class TLog {
	...
	public static final void exceptionError(String log) {
		if (DEBUG)
			Log.e(LOG_TAG, "Exception-->" + log);
	}
	...
	public static final void log(int log) {
		if (DEBUG)
			Log.e(LOG_TAG, log+"");
	}
	...
	public static final void log(String tag, int log) {
		if (DEBUG)
			Log.e(tag, log+"");
	}
